namespace ControleFinanceiro1.Migrations
{
    ...
    public partial class ConsertodonomeEstabelicimento2 : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Compra", "Estabelicimento");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Compra", "Estabelicimento", c => c.Int(nullable: false));
